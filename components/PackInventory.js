...
import { addCardToStore } from "../reducers/users.js";
  ...
  return (
    <div className={styles.container} id={id}>
      ...
      <div className={styles.btnContainer}>
        <button className={styles.btn} onClick={handleModalOpenVisible}>
          OPEN
        </button>
        <button className={styles.btn} onClick={handleModalSellVisible}>
          SELL
        </button>
      </div>
      <Modal
      ...
      <Modal
        ...
        footer={null}
      >
        <OpenPackModal id={id} updateInventory={updateInventory} />
      </Modal>
    </div>
  );
}
